...
- [Advanced Custom Properties](../../methodology/custom-properties-advanced/) — Fallback chains, space toggles, and component APIs that implement the three-tier pattern
- [Theming Recipes](../../methodology/custom-properties-advanced/theming-recipes) — Production-ready theme recipes using this architecture
- [Color Token Patterns](../../methodology/tight-token-strategy/color-tokens) — Applying three-tier tokens in Tailwind's `@theme` system
